...
public record FileMeta(String fileName, String filePath, String folderPath) {
	...
	/**
	 * Creates a FileMeta instance from a Spring Resource.
	 * @param resource the Spring Resource representing a test file
	 * @return a FileMeta instance with extracted file information
	 */
