...
public class TimeWindow {
    ...
    @JsonCreator
    public TimeWindow(@JsonProperty("activeAfter") LocalTime activeAfter, @JsonProperty("activeBefore") LocalTime activeBefore, @JsonProperty("timezone") String timeZone) {
